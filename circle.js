class Vehicle{
    ...
    checkProperties() {
        ...
        if (this.top == 1 && V_applied_p<=0) {
            ...
            } else if (this.color ==1 && this.x<400) {
                 //electron
                 this.origin.x = 0 
                 this.origin.y = 0
                 console.log("The conditions are met for a vehicle instance.");
            ...
            // console.log("Conditions not met for a vehicle instance.");
        }
    }
    ...
    display(){
        ...
        if (this.color == 0){
            ...
            if (this.origin.x == 0 && this.origin.y == 0) {
                    ...
                    //yellow
                    ellipse(this.position.x,(-array_band2[99]+array_band_hardcode[99]+72-array_band_hardcode[99]-this.botz*this.botz*(8.8)*0.2)*s_y,5)

                  
                    this.position2.y=(-array_band2[99]+array_band_hardcode[99]+72-array_band_hardcode[99]-this.botz*this.botz*(8.8)*0.2)*s_y
                    ...
                    fill(254,246,182, 100);
                    stroke(254,246,182, 100);
                    ellipse(this.position.x,((this.origin.x-line_yellow[99][1])-array_band2[99]+array_band_hardcode[99]+72-array_band_hardcode[99]-this.botz*this.botz*(8.8)*0.2)*s_y,5)
 
                    this.position2.y=((this.origin.x-line_yellow[99][1])-array_band2[99]+array_band_hardcode[99]+72-array_band_hardcode[99]-this.botz*this.botz*(8.8)*0.2)*s_y
            ...
            if (sceneCount ==1.5) {
             ...
             if (this.origin.x == 0 && this.origin.y == 0) {
                ...
                //new
                ellipse(this.position.x,((s+111)+this.botz*this.botz*(8.8)*0.2)*s_y,5)


                // this.position2.y=(-3+(k+144)*s_y+this.botz*this.botz*(8.8)*0.2)*s_y

                this.position2.y=((s+111)+this.botz*this.botz*(8.8)*0.2)*s_y
                ...
                this.position2.y=((s+this.origin.y+111-line_green[0][1]-array_band2[0])+this.botz*this.botz*(8.8)*0.2)*s_y
    ...
    random_walk() {
        ...
        if (sceneCount == 1.5 || sceneCount == 2){
        ...
        if ((this.position.x > 940*s_x)&& (opening ==1)) {
            ...
            // if (this.botz <3) {
                ...
                try {
                    ...
                    // if (this.near_index<50)  {
                        ...
                        if (this.color ==0 && this.position2.x <= (line_yellow_data[this.near_index].x+E_gap_factor )) 
                        {this.direction.x = 2;}
