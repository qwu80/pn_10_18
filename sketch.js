...
for (var i = 0; i<100; i++) {
  ...
  if ((800)/100*i>(550-(400)/8*count_pn_num) && (800)/100*i<(550)){
    array_band1[i-19]= -Math.pow(((800)/100*i-(550-(400)/8*count_pn_num))/((400)/8*count_pn_num)*(2*rect_density/(X_n*100)*count_n*2) ,1)/5/3
  }  else if (i==50) {
...
for (var i = 0; i<100; i++) {
  ...
  if (i>50) {
    ...
    array_band1[i]=  -Math.pow((2*rect_density/(X_n*100)*count_n*2) ,1)/5/3
  }
//  triangle((550-(400)/8*count_pn_num)*s_x, (10+385/2+96.25)*s_y, (550+(400)/8*count_pn_num)*s_x, (10+385/2+96.25)*s_y, (550)*s_x, (10+385/2+96.25+  2*rect_density/(X_n*100)*count_n*2)*s_y)
...
beginShape();
  ...
  for (var k = 0; k < 100; k++) {
    //green curve
      ...
      curveVertex((150+(800)/100*k)*s_x,(171.25-array_band3[k]-30)*s_y)
      line_green_data[k] = { x: (150+(800)/100*k)*s_x, y: (171.25-array_band3[k]-30)*s_y};
...
genBalls_scene1 = (num) =>{
  ...
  // generate *num* balls
if (loopp = true && sceneCount ==0.1 && whiteArray.length<13000) {
